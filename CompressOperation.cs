...
namespace de.intronik.backup
{
    ...
    public class CompressOperation : HashOperation
    {
        ...
        protected HashEntry ReplaceByLink(FileSystemInfo fileSystemInfo, HashEntry hash, int level)
        {
        ...
        protected HashEntry ReplaceByLink(DirectoryInfo dirInfo, HashEntry hash, int level)
        {
        ...
        protected HashEntry ReplaceByLink(FileInfo fileInfo, HashEntry hash, int level)
        {
            var hashPath = this.GetFullHashPath(hash);
            // either move current file to hash folder or delete it
        ...
        protected HashEntry Handle(FileSystemInfo fileSystemInfo, int level)
        {
        ...
        protected HashEntry Handle(FileInfo fileInfo, int level)
        {
        ...
        protected HashEntry Handle(DirectoryInfo dirInfo, int level)
        {
            // first check if the file is already a symbolic hash link, if so we are done!
